...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Dr. Forrás-Bíró Aletta pszichológus</title>
        ...
        <div class="container"><a class="navbar-brand" href="index.html">
            ...
            <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
                    <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="#about">Kezdőoldal</a></li>
                    <li class="nav-item px-2"><a class="nav-link" href="#departments">Magamról</a></li>
                    <li class="nav-item px-2"><a class="nav-link" href="#findUs">Események</a></li>
                    <li class="nav-item px-2"><a class="nav-link" href="#findUs">Programok</a></li>
{{--                    <li class="nav-item px-2"><a class="nav-link" href="#findUs"></a></li>--}}
                </ul><a class="btn btn-sm btn-outline-primary rounded-pill order-1 order-lg-0 ms-lg-4" href="#!">Időpontfoglalás</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            <div class="row min-vh-xl-100 min-vh-xxl-25">
                ...
                <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-6">
                    <h1 class="fw-light font-base fs-6 fs-xxl-7">Dr. Forrás-Biró Aletta vagyok, <strong>pszichológus. </strong></h1>
                    <p class="fs-1 mb-5">Segíthetek Neked <strong>korlátaid leküzdésében.</strong> - ide találjunk ki valami <strong>sokkal jobbat </strong></p><a class="btn btn-lg btn-primary rounded-pill" href="#!" role="button">Időpontfoglalás</a>
                </div>
            </div>
        </div>
    </section>
